...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between align-items-center">
        <h6 class="m-0 font-weight-bold text-primary">Services &RightArrow; Create </h6>
    ...
    <div class="card-body">
        <form action="<?php echo base_url('services_create_action'); ?>" method="POST" enctype="application/x-www-form-urlencoded">
